  ...
  function SlickGridPager(dataView, grid, $container) {
    ...
    function constructPagerUI() {
      ...
      var $settings = $("<span class='slick-pager-settings' />").appendTo($container);
        ...
        $showFilter = $("<span class='slick-pager-filter' />").appendTo($container);
        $showFilter.text('show filter');

        $('.slick-pager-filter').click(function(){
            grid.setHeaderRowVisibility(!$(grid.getHeaderRow()).is(":visible"))
        });
